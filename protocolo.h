...
#define PORTA_C 50969
#define PORTA_S 40695
#define INTERFACE_PADRAO "enp3s0"
...
// Estado do protocolo - MODIFICADO para usar raw socket
typedef struct {
    rawsocket_t rawsock;         // Raw socket context
    uint8_t seq_atual;
    unsigned char seq_esperada;
    char dest_ip[16];            // IP de destino
...
// Funções do protocolo - MODIFICADAS para raw socket
int inicializar_protocolo(estado_protocolo_t* estado, const char* dest_ip, unsigned short orig_port,
